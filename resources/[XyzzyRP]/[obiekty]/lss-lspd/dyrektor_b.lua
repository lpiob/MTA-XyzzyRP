...
local drzwi={}
drzwi.obiekt=createObject(1495,1559.9716796875,-1658.80859375,1463.7819824219,0,0,0)
...
local function pracownik(id)
    ...
    if (wynik and wynik.rank and tonumber(wynik.rank)>=6 and tonumber(wynik.rank)<=9) then return true else return false end
end
