...
local drzwi={}
drzwi.obiekt=createObject(2930,1575.1839599609,-1698.8439941406,1462.5098876953,0,0,90)
setElementData(drzwi.obiekt,"customAction",{label="Otwórz/zamknij",resource="lss-lspd",funkcja="menu_drzwi",args={}})
...
drzwi.otworz=function()
    ...
    drzwi.animacja=true
    moveObject(drzwi.obiekt,3000,1575.1839599609-1.5,-1698.8439941406,1462.5098876953,0,0,0,"OutBounce")
...
drzwi.zamknij=function()
    ...
    drzwi.animacja=true	
    moveObject(drzwi.obiekt,3000,1575.1839599609,-1698.8439941406,1462.5098876953,0,0,0,"OutBounce")
...
local function pracownik(id)
    ...
    if (wynik and wynik.rank and tonumber(wynik.rank)>=6 and tonumber(wynik.rank)<=8) then return true else return false end
end
