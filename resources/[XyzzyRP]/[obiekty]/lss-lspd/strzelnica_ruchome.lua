...
local obiekty={ "plansza_1", "plansza_2",  "plansza_3",  "plansza_4",  "plansza_5",  "plansza_6",  "plansza_7",  "plansza_8", "platforma"  }
		-- , "statek5", "statek6", "statek7", "statek8", "statek9", "statek10", "statek11", "statek12", "statek13", "statek14", "statek15", "statek16", "statek17", "statek18"}


local sekwencja={
	{ nazwa="1", czas=10, opoznienie=20 },
	{ nazwa="2", czas=10, opoznienie=20 },	
