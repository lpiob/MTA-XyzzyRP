...
-- 																  ^ opcjonalny argument frakcja okresla jaka frakcja (tylko jedna) moze miec dostep
	...
	-- drzwi na dach w sluzbach specjalnych
	{ colsphere={ 1220.65,-1452.09,2261.57, 1, 1, 40}, obiekty={ "drzwi_ss_dach1", "drzwi_ss_dach2" }, frakcja="Sluzby Specjalne", minrankid=6},

	-- drzwi do glownego korytarza w sluzbach specjalnych
--	{ colsphere={ 1204.63,-1427.49,2177.17, 1, 1, 40}, obiekty={ "drzwi_ss_1", "drzwi_ss_2" }, frakcja="Sluzby_Specjalne" },
