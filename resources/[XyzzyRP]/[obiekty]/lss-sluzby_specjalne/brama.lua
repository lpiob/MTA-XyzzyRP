local brama={}
brama.obiekt=createObject(2990,1232.8134765625,-1475.2646484375,16.460855484009,0,0,90)
setElementData(brama.obiekt,"customAction",{label="Otwórz/zamknij",resource="lss-sluzby_specjalne",funkcja="menu_brama1",args={}})
...
brama.otworz=function()
    ...
    brama.animacja=true
    moveObject(brama.obiekt,5000,1232.8134765625,-1475.2646484375,16.460855484009+5,0,0,0,"OutBounce")
...
brama.zamknij=function()
    ...
    brama.animacja=true	
    moveObject(brama.obiekt,5000,1232.8134765625,-1475.2646484375,16.460855484009,0,0,0,"OutBounce")
...
addEvent("onSluzby_specjalneBrama1ToggleRequest", true)
addEventHandler("onSluzby_specjalneBrama1ToggleRequest", resourceRoot, brama.toggle)
