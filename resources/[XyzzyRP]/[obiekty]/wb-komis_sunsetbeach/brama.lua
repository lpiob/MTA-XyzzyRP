...
brama.o=getElementByID("ksb_brama")
...
setElementData(brama.o,"customAction",{label="Otwórz/zamknij",resource="wb-komis_sunsetbeach",funkcja="menu_brama",args={}})
end)
...
brama.otworz=function()
    ...
    moveObject(brama.o,5000,2453.5483398438, 99.499566650391, 27.180591583252,0,0,0,"OutBounce")
...
brama.zamknij=function()
    ...
    moveObject(brama.o,5000,2453.5483398438, 92.499566650391, 27.180591583252,0,0,0,"OutBounce")
