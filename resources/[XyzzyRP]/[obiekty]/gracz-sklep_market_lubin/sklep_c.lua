...
local oferta ={
	{ name="Baton czekoladowy", name_biernik="batona", itemid=90, count=1, cost=4},
	{ name="Papierosy", name_biernik="papierosy", itemid=1, count=10, cost=20},
	{ name="Owoce", name_biernik="owoce", itemid=91, count=1, cost=4},
	{ name="Sok gabłkowy", name_biernik="sok", itemid=85, count=1, cost=2},
...
local lada=createColSphere(1819.84,-1058.29,2181.54,1)
