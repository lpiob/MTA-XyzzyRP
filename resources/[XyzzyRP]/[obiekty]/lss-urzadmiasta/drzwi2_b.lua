-- biuro zastepcy burmistrza
local drzwi={}
drzwi.obiekt=createObject(1495,1481.3564453125,-1785.0126953125,1251.9598388672,0,0,180)
setElementData(drzwi.obiekt,"customAction",{label="Otwórz/zamknij",resource="lss-urzadmiasta",funkcja="menu_drzwi2",args={}})
...
drzwi.otworz=function()
    ...
    drzwi.animacja=true
    moveObject(drzwi.obiekt,3000,1481.3564453125,-1785.0126953125,1251.9598388672,0,0,-90,"OutBounce")
...
local function pracownik(id)
    ...
    if (wynik and wynik.rank and tonumber(wynik.rank)>=2 and tonumber(wynik.rank)<=3) then return true else return false end
end
...
addEvent("onUM_Drzwi2ToggleRequest", true)
addEventHandler("onUM_Drzwi2ToggleRequest", resourceRoot, drzwi.toggle)
