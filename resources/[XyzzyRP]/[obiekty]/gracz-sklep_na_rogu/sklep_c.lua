...
local oferta ={
	...
	{ name="Woda niegazowana", name_biernik="wodę", itemid=87, count=1, cost=2},
	{ name="Sok jabłkowy", name_biernik="sok", itemid=85, count=1, cost=2},
	{ name="Owoce", name_biernik="owoce", itemid=91, count=1, cost=4},
	{ name="Wafel czekoladowy", name_biernik="batona", itemid=90, count=1, cost=4},
}
...
local lada=createColSphere(1348.34,-1761.09,2035.48,1)
