...
local drzwi={}
drzwi.obiekt=createObject(1495,930.67761230469,-1287.3890380859,1439.9249267578,0,0,180)
setElementData(drzwi.obiekt,"customAction",{label="Otwórz/zamknij",resource="lss-straz",funkcja="menu_drzwi",args={}})

-- dimension
setElementDimension(drzwi.obiekt, 26)  -- bylo drzwi, ma byc drzwi.obiekt (tak jak wyzej)
-- interior
...
drzwi.otworz=function()
    ...
    drzwi.animacja=true
    moveObject(drzwi.obiekt,3000,930.67761230469,-1287.3890380859,1439.9249267578,0,0,90,"OutBounce")
...
local function pracownik(id)
    ...
    if (wynik and wynik.rank and tonumber(wynik.rank)>=7 and tonumber(wynik.rank)<=9) then return true else return false end
end
...
addEvent("onFDDrzwiToggleRequest", true)
addEventHandler("onFDDrzwiToggleRequest", resourceRoot, drzwi.toggle)
