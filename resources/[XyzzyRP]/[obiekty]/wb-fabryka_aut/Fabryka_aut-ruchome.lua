...
local sekwencja={
	{ nazwa="1", czas=1, opoznienie=0.05 },
	{ nazwa="2", czas=7, opoznienie=3 },
	{ nazwa="3", czas=7, opoznienie=0.05 },
	{ nazwa="4", czas=0.05, opoznienie=0.05 },
	{ nazwa="5", czas=0.05, opoznienie=0.05 },
