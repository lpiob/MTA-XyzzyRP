local brama={}
brama.l=createObject(985,2771.7744140625,-2490.1943359375,14.382947921753,0,0,90)
brama.r=createObject(986,2771.7744140625,-2498.1533203125,14.382947921753,0,0,90)

-- dimension
setElementDimension(brama.l, 0) 
setElementDimension(brama.r, 0) 
-- interior
setElementInterior(brama.l, 0) 
setElementInterior(brama.r, 0) 

setElementData(brama.l,"customAction",{label="Otwórz/zamknij",resource="lss-wiezienie",funkcja="menu_brama1",args={}})
setElementData(brama.r,"customAction",{label="Otwórz/zamknij",resource="lss-wiezienie",funkcja="menu_brama1",args={}})
...
--    local _,_,rz=getElementRotation(brama.l)
    moveObject(brama.l,5000,2771.7744140625,-2490.1943359375+6,14.382947921753,0,0,0,"OutBounce")
    
--    local _,_,rz=getElementRotation(brama.r)
    moveObject(brama.r,5000,2771.7744140625,-2498.1533203125-6,14.382947921753,0,0,0,"OutBounce")
...
brama.zamknij=function()
    ...
    moveObject(brama.l,5000,2771.7744140625,-2490.1943359375,14.382947921753,0,0,0,"OutBounce")

    local _,_,rz=getElementRotation(brama.r)
    moveObject(brama.r,5000,2771.7744140625,-2498.1533203125,14.382947921753,0,0,0,"OutBounce")
...
addEvent("onGlownaBramaToggleRequest", true)
addEventHandler("onGlownaBramaToggleRequest", resourceRoot, brama.toggle)
