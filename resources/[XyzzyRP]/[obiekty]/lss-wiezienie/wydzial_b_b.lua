local brama={}
brama.l=createObject(2930,2694.0419921875,-2653.6484375,8.8243560791016,0,0,0)
brama.r=createObject(2930,2694.044921875,-2652.0185546875,8.8243560791016,0,0,0)
...
setElementData(brama.l,"customAction",{label="Otwórz/zamknij",resource="lss-wiezienie",funkcja="menu_brama4",args={}})
setElementData(brama.r,"customAction",{label="Otwórz/zamknij",resource="lss-wiezienie",funkcja="menu_brama4",args={}})
...
--    local _,_,rz=getElementRotation(brama.l)
    moveObject(brama.l,5000,2694.0419921875,-2653.6484375-1,8.8243560791016,0,0,0,"OutBounce")
    
--    local _,_,rz=getElementRotation(brama.r)
    moveObject(brama.r,5000,2694.044921875,-2652.0185546875+1,8.8243560791016,0,0,0,"OutBounce")
...
brama.zamknij=function()
    ...
    moveObject(brama.l,5000,2694.0419921875,-2653.6484375,8.8243560791016,0,0,0,"OutBounce")

    local _,_,rz=getElementRotation(brama.r)
    moveObject(brama.r,5000,2694.044921875,-2652.0185546875,8.8243560791016,0,0,0,"OutBounce")
...
addEvent("onWydzial_bBramaToggleRequest", true)
addEventHandler("onWydzial_bBramaToggleRequest", resourceRoot, brama.toggle)
