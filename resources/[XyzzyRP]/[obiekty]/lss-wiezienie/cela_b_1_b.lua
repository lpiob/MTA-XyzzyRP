local brama={}
brama.l=createObject(2930,2690.99609375,-2656.6105957031,8.8243560791016,0,0,0)
brama.r=createObject(2930,2690.99609375,-2658.2595214844,8.8243560791016,0,0,0)
...
setElementData(brama.l,"customAction",{label="Otwórz/zamknij",resource="lss-wiezienie",funkcja="menu_brama11",args={}})
setElementData(brama.r,"customAction",{label="Otwórz/zamknij",resource="lss-wiezienie",funkcja="menu_brama11",args={}})
...
--    local _,_,rz=getElementRotation(brama.l)
    moveObject(brama.l,5000,2690.99609375,-2656.6105957031+2.5,8.8243560791016,0,0,0,"OutBounce")
    
--    local _,_,rz=getElementRotation(brama.r)
    moveObject(brama.r,5000,2690.99609375,-2658.2595214844+2.5,8.8243560791016,0,0,0,"OutBounce")
...
brama.zamknij=function()
    ...
    moveObject(brama.l,5000,2690.99609375,-2656.6105957031,8.8243560791016,0,0,0,"OutBounce")

    local _,_,rz=getElementRotation(brama.r)
    moveObject(brama.r,5000,2690.99609375,-2658.2595214844,8.8243560791016,0,0,0,"OutBounce")
...
brama.toggle=function(gracz)
	...
	local lfrid=tonumber(getElementData(gracz,"faction:rank_id"))
...
addEvent("onCela_b_1BramaToggleRequest", true)
addEventHandler("onCela_b_1BramaToggleRequest", resourceRoot, brama.toggle)
