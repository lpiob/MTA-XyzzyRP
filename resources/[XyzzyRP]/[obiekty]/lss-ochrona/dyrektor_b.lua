...
local drzwi={}
drzwi.obiekt=createObject(1495,2147.0522460938,-1777.4084472656,1421.5125732422,0,0,180)
setElementData(drzwi.obiekt,"customAction",{label="Otwórz/zamknij",resource="lss-ochrona",funkcja="menu_drzwi",args={}})

-- dimension
setElementDimension(drzwi.obiekt, 31)  -- bylo drzwi, ma byc drzwi.obiekt (tak jak wyzej)
-- interior
...
drzwi.otworz=function()
    ...
    drzwi.animacja=true
    moveObject(drzwi.obiekt,3000,2147.0522460938,-1777.4084472656,1421.5125732422,0,0,90,"OutBounce")
...
local function pracownik(id)
    ...
    if (wynik and wynik.rank and tonumber(wynik.rank)>=5 and tonumber(wynik.rank)<=5) then return true else return false end
end
...
addEvent("onOchronaBrama2ToggleRequest", true)
addEventHandler("onOchronaBrama2ToggleRequest", resourceRoot, drzwi.toggle)
