...
local obiekty={ "robot1", "robot2", "lina1", "lina2", "lina3", "lina4", "lina5", "hak", "guma" }
		-- , "statek5", "statek6", "statek7", "statek8", "statek9", "statek10", "statek11", "statek12", "statek13", "statek14", "statek15", "statek16", "statek17", "statek18"}


local sekwencja={
	{ nazwa="1", czas=70, opoznienie=10 },	
	{ nazwa="2", czas=30, opoznienie=20 },		
	{ nazwa="3", czas=40, opoznienie=20 },
	{ nazwa="4", czas=70, opoznienie=10 },
	{ nazwa="5", czas=30, opoznienie=20 },
	{ nazwa="6", czas=40, opoznienie=20 },
