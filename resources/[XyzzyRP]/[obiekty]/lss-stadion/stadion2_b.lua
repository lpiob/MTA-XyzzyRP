...
local drzwi={}
drzwi.obiekt=createObject(976,2673.060546875,-1764.2978515625,3070.8012695313,0,0,0)
setElementData(drzwi.obiekt,"customAction",{label="Otwórz/zamknij",resource="lss-stadion",funkcja="menu_drzwi2",args={}})

-- dimension
setElementDimension(drzwi.obiekt, 77)  -- bylo drzwi, ma byc drzwi.obiekt (tak jak wyzej)
-- interior
...
drzwi.otworz=function()
    ...
    drzwi.animacja=true
    moveObject(drzwi.obiekt,6000,2673.060546875+5,-1764.2978515625,3070.8012695313,0,0,0,"OutBounce")
...
drzwi.zamknij=function()
    ...
    drzwi.animacja=true	
    moveObject(drzwi.obiekt,6000,2673.060546875,-1764.2978515625,3070.8012695313,0,0,0,"OutBounce")
...
addEvent("onStadion2BramaToggleRequest", true)
addEventHandler("onStadion2BramaToggleRequest", resourceRoot, drzwi.toggle)
