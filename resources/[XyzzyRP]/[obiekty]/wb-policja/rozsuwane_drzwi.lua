...
-- 																  ^ opcjonalny argument frakcja okresla jaka frakcja (tylko jedna) moze miec dostep
	...
	{ colsphere={ 1576.12,-1698.87,1460.87, 1, 1, 5}, obiekty={ "brama" }, frakcja="Policja"},
	-- brama wjazdowa na parking
	{ colsphere={1592.11,-1637.63,13.54, 8, 0, 0}, obiekty={ "brama_1_komLS" }, frakcja="Policja" },
	-- brama wejsciowa na parking
	{ colsphere={1583.48,-1638.25,13.35, 1, 0, 0}, obiekty={ "brama_2_komLS" }, frakcja="Policja" },	
	-- drzwi przy dachu
	{ colsphere={1635.89,-1682.97,1463.48, 1, 1, 5}, obiekty={ "dach_komLS_1", "dach_komLS_2" }, frakcja="Policja" },		
}
