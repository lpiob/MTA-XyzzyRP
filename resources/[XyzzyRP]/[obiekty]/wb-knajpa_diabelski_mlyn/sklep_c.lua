...
local oferta ={
	...
	{ name="Piwo", name_biernik="piwo", itemid=42, count=1, cost=5},
	{ name="Drink", name_biernik="drinka", itemid=22, count=1, cost=7},
	{ name="Woda", name_biernik="wodę", itemid=87, count=1, cost=3},
...
local lada=createColSphere(1655.93,-1653.92,2571.74,1)
