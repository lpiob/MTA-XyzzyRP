...
local brama={}
brama.l=createObject(985,122.59523010254,-166.80458068848,2.3273661136627,0,0,270)
brama.r=createObject(986,122.59523010254,-158.82177734375,2.3273661136627,0,0,270)


setElementData(brama.l,"customAction",{label="Otwórz/zamknij",resource="lss-warsztat5",funkcja="menu_brama",args={}})
setElementData(brama.r,"customAction",{label="Otwórz/zamknij",resource="lss-warsztat5",funkcja="menu_brama",args={}})
...
--    local _,_,rz=getElementRotation(brama.l)
    moveObject(brama.l,5000,122.59523010254,-166.80458068848-7,2.3273661136627,0,0,0,"OutBounce")
    
--    local _,_,rz=getElementRotation(brama.r)
    moveObject(brama.r,5000,122.59523010254,-158.82177734375+7,2.3273661136627,0,0,0,"OutBounce")
...
brama.zamknij=function()
    ...
    moveObject(brama.l,5000,122.59523010254,-166.80458068848,2.3273661136627,0,0,0,"OutBounce")

    local _,_,rz=getElementRotation(brama.r)
    moveObject(brama.r,5000,122.59523010254,-158.82177734375,2.3273661136627,0,0,0,"OutBounce")
...
addEvent("onWarsztat5BramaToggleRequest", true)
addEventHandler("onWarsztat5BramaToggleRequest", resourceRoot, brama.toggle)
