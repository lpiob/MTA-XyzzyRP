...
-- 																  ^ opcjonalny argument frakcja okresla jaka frakcja (tylko jedna) moze miec dostep
	...
	-- drzwi na dach
	{ colsphere={ 2018.47,-1383.00,1286.67, 1, 1, 8}, obiekty={ "dach_szpital_1", "dach_szpital_2" }, frakcja="Pogotowie", minrankid=7},
	-- drzwi na parking
	{ colsphere={ 2024.74,-1378.95,1271.07, 1, 1, 8}, obiekty={ "parking_szpital_1", "parking_szpital_2" }, frakcja="Pogotowie" },
	-- brama na parking	
	{ colsphere={ 2001.13,-1406.51,13.53, 7, 0, 0}, obiekty={ "brama_szpital" }, frakcja="Pogotowie" },
	--drzwi w szpitalu do serca
	{ colsphere={ 2047.41,-1374.63,2298.95, 1, 0, 0}, obiekty={ "serce" }, frakcja="Pogotowie" },
}
